...
% Keep the abstract and thesis committee together on the formal title page.
\makeatletter
...
%\colophon{\noindent
%  \copyright{} \the\year \: \theauthor. All rights reserved.
%}

% thesis committee:
\chair{Dr. Z. Perk{\'o}, Reactor Institute Delft, TU Delft}
\committeemember{Dr.ir. D. Lathouwers, Reactor Institute Delft, TU Delft}
\committeemember{Prof.dr.ir. M.B. van Gijzen, Delft Institute of Applied Mathematics, TU Delft}
\supervisor{Alessandro Longhi, Reactor Institute Delft, TU Delft}
...
\makeformaltitlepages{\input{sections/abstract}}         % for formal title pages with all info
...
\input{sections/uniform_results_discussion}
\input{sections/non_uniform_results_discussion}
