...
mesh. The coordinate transform MLP $\phi^{-1}$ was given the x and y coordinates of the cylinder's center and its radius. In addition to the horizontal and vertical velocity
components, each mesh point was  also assigned a one-hot encoding of its node
