...
The input to the HTGR model consists of the boundary temperature $T$ and
the axial level $z$. Since this raw representation is low-dimensional,
multiple input representations were tested using feature engineering.
Feature engineering refers to the transformation or augmentation of raw
input variables into a representation that is more informative for the
machine learning model, and prior work has shown that such feature
engineering can improve predictive performance \cite{feature-engineering}. 
A subset of the input representations tested for the
HTGR dataset, and their effect on model performance, are presented in
