...
thesis. In particular, the full generation procedure for the Navier-Stokes dataset generated in this work is deferred to Appendix~\ref{navier-details}.
...
data was produced as part of ongoing work by a colleague within the RPNM group.
...
samples from the datasets described above. For the uniform experiments, the data is
...
performance. For the non-uniform experiments, a validation set was also included, with all the listed losses being from this set.
