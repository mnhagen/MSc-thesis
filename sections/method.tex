...
self-generated Navier-Stokes dataset is deferred to Appendix~\ref{navier-details}.
...
Appendix~\ref{cha:geo-fno-bug-fix}. The results in the main text are reported
